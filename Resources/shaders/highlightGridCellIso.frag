...
void main()
{
	...
	f1 = max(0, pow(f1, 14.0) / pow(1.0, 14.0));
	f2 = max(0, pow(f2, 14.0) / pow(1.0, 14.0));
	...
	gl_FragColor = texColor * (1.0 - f1 - f2) + (f1 * reversef1 + f2 * reversef2) * vec4(border_color, texColor.a);
}