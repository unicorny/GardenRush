...
public:
	...
	inline u32			getNItems( ) const		{	return m_nItems;						}
...
public:
	...
	// make room for entrys if entry count is know, else memory allocation will be handled automaticly,
	// in add, make room for 32 new items if memory allocated exceeded
	bool initMemory(u32 numItems);
